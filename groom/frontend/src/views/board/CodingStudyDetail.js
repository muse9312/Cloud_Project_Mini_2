...
const CodingStudyDetail = () => {
  ...
  useEffect(() => {
    axios({
      url: 'http://localhost:8080/board/CodingStudy/CodingStudyWrite',
      method: 'get',
      params: { id: id }
    }).then((res) => {
              ...
              <form method="post" class="post-form my-3"
                encType="multipart/form-data" onSubmit={(e) => {
                  ...
                  axios({
                    ...
                    console.log(res.data);
                    window.location = `/admin/CodingStudyDetail/${id}`;
                  });
                ...
                <CardFooter className="py-4">
                  ...
                  <button type="button" class="btn btn-primary" onClick={()=>{
                    window.location= "admin/CodingStudyUpdate"}}>수정 </button>
...
export default CodingStudyDetail;
